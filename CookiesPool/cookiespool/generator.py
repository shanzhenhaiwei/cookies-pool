...
from login.weibo.login import Login
    ...
    def run(self):
        ...
        for username in accounts_usernames:
            if not username in cookies_usernames:
                ...
                cookies=self.new_cookies(username,password)
                # 成功获取
                if cookies:
...
class WeiboCookiesGenerator(CookiesGenerator):
    ...
    def new_cookies(self, username, password):
        ...
        return Login(browser=self.browser,username=username, password=password).login()
